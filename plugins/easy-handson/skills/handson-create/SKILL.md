...
| 7 | ディスカッション | 業務シーン例3つ + Teams投稿フォーマット |

スライド7（ディスカッション）の内容構成:
- タイトル: 💬 {機能名} × 実業務 — 使い方を考えてみよう
- 業務シーン例を3つ（各1行）: 「〜という作業が、〜に変わる」形式
- 区切り線の下に Teams 投稿フォーマット枠:
  【{機能名} を試してみた！】
  ✅ 試した内容：
  💡 使えそうな場面：
  😲 一番驚いたこと：
- 最下部に一言: 「一番リアルな投稿にいいね！を集めよう 🎉」
...
【次のアクション】
1. slides.pptx を確認・調整する（7枚目がディスカッションページ）
2. announce.txt の日時・場所を埋めて投稿する
3. handson.md を参加者に共有する
4. ハンズオン後にスライドの最終ページを見ながら Teams に投稿してもらう！
```
...
- ディスカッションスライドの業務シーン例は、通信・社内DX・資料作成・情報収集など身近な業務を選ぶ
