...
| コマンド | 内容 |
|---------|------|
| `/research` | Claude Code など注目分野の最新AI機能を一覧で取得 |
| `/research [キーワード]` | キーワード指定でリサーチ（例: `/research gemini`） |
| `/create [機能名]` | 選んだ機能のスライド・手順書・周知文を一括生成 |

**生成物 (outputs/{機能名}/):**
- `slides.md` — 紹介スライド（6枚、majin-slide形式）
- `handson.md` — 参加者向け手順書（15分で完走できる粒度）
- `announce.txt` — Teams/Slack 周知文のテンプレート

**必要環境:** インターネット接続（WebSearch）、majin-slide MCP
